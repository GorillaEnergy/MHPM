;(function () {
    ...
    Call3Controller.$inject = ['$localStorage', '$state', '$timeout'];

    function Call3Controller($localStorage, $state, $timeout) {
       let vm = this;
       console.log('Call3Controller start');
       console.log('Multiple peer connections');
        ...
        function gotStream(stream) {
            ...
            $localStorage.streamUrl = stream.id;
        }
