;(function () {
    'use strict';
    angular.module('app')
        .controller('Call2Controller', Call2Controller);

    Call2Controller.$inject = ['$localStorage', '$state', '$timeout'];

    function Call2Controller($localStorage, $state, $timeout) {
       let vm = this;
       console.log('Call2Controller start');
       console.log('Peer connection upgrade');
