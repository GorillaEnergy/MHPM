function initializeBRF(brfv4) {
    var brfv4SDK = function (brfv4SDK) {
        ...
        function integrateWasmJS() {
            var wasmTextFile = "BRFv4_JS_TK101018_v4.1.0.wast";
            var wasmBinaryFile = "BRFv4_JS_TK101018_v4.1.0.wasm";
            var asmjsCodeFile = "BRFv4_JS_TK101018_v4.1.0.temp.asm.js";
    ...
    (function (lib) {
        ...
        lib.BRFv4Context = function () {
            ...
            var mapUint8DataToArray = function (array, data) {
                var i = 0;
                var l = data.length;
                if (array.length > l) array.splice(l, array.length - l); else array.length = l;
                while (i < l) {
                    array[i] = data[i];
                    ++i
                }
            ...
            _this.getAllDetectedFaces = function (result) {
                var dataLength = _brf_c_get_allDetectedFaces_length() *
                    4;
                if (dataLength <= 0) clearArray(result); else retrieveFloat32ArrayAndMap(_brf_c_get_allDetectedFaces, mapFloat32DataToRectangleArray, dataLength, result)
            };
            ...
            _this.getMergedDetectedFaces = function (result) {
                ...
                if (dataLength <= 0) clearArray(result); else retrieveFloat32ArrayAndMap(_brf_c_get_mergedDetectedFaces,
            ...
            _this.getFaces = function (result) {
                ...
                for (var fi = 0; fi < numFaces; fi++) {
                    ...
                    if (dataLength <= 0) clearArray(face.vertices); else retrieveFloat32ArrayAndMapIndex(_brf_c_get_face_vertices, fi, mapFloat32DataToArray, dataLength, face.vertices);
                    if (face.triangles.length == 0) {
                        dataLength = _brf_c_get_face_triangles_length(fi);
                        if (dataLength <= 0) clearArray(face.triangles); else retrieveUint8ArrayAndMapIndex(_brf_c_get_face_triangles,
                            fi, mapUint8DataToArray, dataLength, face.triangles)
                    }
                    dataLength = _brf_c_get_face_points_length(fi) * 2;
                    if (dataLength <= 0) clearArray(face.points); else retrieveFloat32ArrayAndMapIndex(_brf_c_get_face_points, fi, mapFloat32DataToPointArray, dataLength, face.points);
                    ...
                    if (dataLength <= 0) clearArray(face.candideVertices); else retrieveFloat32ArrayAndMapIndex(_brf_c_get_face_candideVertices, fi, mapFloat32DataToArray, dataLength, face.candideVertices);
                    if (face.candideTriangles.length == 0) {
                        dataLength = _brf_c_get_face_candideTriangles_length(fi);
                        if (dataLength <= 0) clearArray(face.candideTriangles); else retrieveUint8ArrayAndMapIndex(_brf_c_get_face_candideTriangles, fi, mapUint8DataToArray, dataLength, face.candideTriangles)
                    }
            ...
            _this.getOpticalFlowPoints = function (result) {
                ...
                if (dataLength <= 0) clearArray(result); else retrieveFloat32ArrayAndMap(_brf_c_get_opticalFlowPoints, mapFloat32DataToPointArray, dataLength, result)
            };
            ...
            _this.getOpticalFlowPointStates = function (result) {
                ...
                if (dataLength <= 0) clearArray(result); else retrieveUint8ArrayAndMap(_brf_c_get_opticalFlowPointStates, mapUint8DataToBooleanArray, dataLength, result)
            };
