;(function () {
    ...
    angular
        .module('service.rtcController', [])
        .service('rtcController', rtcController);

    rtcController.$inject = ['$rootScope'];

    function rtcController($rootScope) {
        console.log('rtcController start');
